@AutoVisitPLv2
Feature: PLv2 CPOE On Charge Capture
  ...
  Scenario Outline: plv2u1 CPOE On - Charge Capture
...
Scenario Outline: plv2u2 CPOE On - Charge Capture-Search from Patient Search-Patient
...
Scenario Outline: plv2u2 CPOE On - Charge Capture-Search from Patient Search-Visit
Given I am logged into the portal with user "plv2u2" using the default password
And I am on the "Patient Search" tab
And I click the "Clear Criteria" button
And I check the following checkboxes
...
| Patient01        | Avstest         | 02262239101    | Inpatient     | %1 day ago MM/dd/yy%  | %1 day ago MM-dd-yyyy% I Visit (VST.VST1.1.PKHospital)        |
| Patient02        | Avstest         | 0226224546     | Observation   | %1 day ago MM/dd/yy%  | %1 day ago MM-dd-yyyy% Obs Visit (VST.VST1.1.PKHospital)      |
| Patient03        | Avstest         | 0226224950     | ER            | %1 day ago MM/dd/yy%  | %1 day ago MM-dd-yyyy% E Visit (VST.VST1.1.PKHospital)        |
| Patient04        | Avstest         | 0226225152     | Inpatient     | %1 day ago MM/dd/yy%  | %1 day ago MM-dd-yyyy% I Visit (VST.VST1.1.PKHospital)        |
| Patient05        | Avstest         | 0226225456     | ER            | %2 day ago MM/dd/yy%  | %2 days ago MM-dd-yyyy% E Visit (VST.VST2.1.PKHospital)       |
| Patient06        | Avstest         | 0226225759     | Inpatient     | %2 day ago MM/dd/yy%  | %2 days ago MM-dd-yyyy% I Visit (VST.VST2.1.PKHospital)       |
| Patient07        | Avstest         | 0226226063     | Inpatient     | %1 day ago MM/dd/yy%  | %1 day ago MM-dd-yyyy% I Visit (VST.VST3.1.PKHospital)        |
| Patient08        | Avstest         | 02262264101    | ER            | %1 day ago MM/dd/yy%  | %1 day ago MM-dd-yyyy% E Visit (VST.VST1.1.PKHospital)        |
| Patient09        | Avstest         | 02262268101    | ER            | %3 day ago MM/dd/yy%  | %3 days ago MM-dd-yyyy% E Visit (VST.VST2.1.PKHospital)       |
| Patient10        | Avstest         | 02262271101    | Pre-Admission | %5 day ago MM/dd/yy%  | %5 days ago MM-dd-yyyy% Pre IP Visit (VST.VST2.1.PKHospital)  |
| Patient11        | Avstest         | 02262274101    | ER            | %1 day ago MM/dd/yy%  | %1 day ago MM-dd-yyyy% E Visit (VST.VST2.1.PKHospital)        |

Scenario Outline: plv2u3 CPOE On - Charge Capture-Search from Patient Search-Patient
...
Scenario Outline: plv2u3 CPOE On - Charge Capture-Search from Patient Search-Visit
Given I am logged into the portal with user "plv2u3" using the default password
And I am on the "Patient Search" tab
And I click the "Clear Criteria" button
And I check the following checkboxes
...
Scenario Outline: plv2u4 CPOE On - Charge Capture
...
Scenario Outline: plv2u5 CPOE On - Charge Capture
...
Scenario Outline: plv2u6 CPOE On - Charge Capture-Search from Patient Search-Patient
...
Scenario Outline: plv2u6 CPOE On - Charge Capture-Search from Patient Search-Visit
Given I am logged into the portal with user "plv2u6" using the default password
And I am on the "Patient Search" tab
And I click the "Clear Criteria" button
And I check the following checkboxes
...
Scenario Outline: plv2u7 CPOE On - Charge Capture-Search from Patient Search-Patient
...
Scenario Outline: plv2u7 CPOE On - Charge Capture-Search from Patient Search-Visit
Given I am logged into the portal with user "plv2u7" using the default password
And I am on the "Patient Search" tab
And I click the "Clear Criteria" button
And I check the following checkboxes
...
| Patient07        | Avstest         | 0226226063     | Inpatient     | %1 day ago MM/dd/yy%  | %1 day ago MM-dd-yyyy% I Visit (VST.VST3.1.PKHospital)        |
| Patient08        | Avstest         | 02262264101    | ER            | %1 day ago MM/dd/yy%  | %1 day ago MM-dd-yyyy% E Visit (VST.VST1.1.PKHospital)        |
| Patient09        | Avstest         | 02262268101    | ER            | %3 days ago MM/dd/yy% | %3 days ago MM-dd-yyyy% E Visit (VST.VST2.1.PKHospital)       |
| Patient10        | Avstest         | 02262271101    | Pre-Admission | %5 day ago MM/dd/yy%  | %5 days ago MM-dd-yyyy% Pre IP Visit (VST.VST2.1.PKHospital)  |
| Patient11        | Avstest         | 02262274101    | ER            | %1 day ago MM/dd/yy%  | %1 day ago MM-dd-yyyy% E Visit (VST.VST2.1.PKHospital)        |


Scenario Outline: plv2u8 CPOE On - Charge Capture

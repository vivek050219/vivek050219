@AutoVisitPLv2
Feature: PLv2 CPOE On NoteWriter
  ...
  Scenario Outline: plv2u1 CPOE On - NoteWriter
...
#    And I refresh the patient list
  ...
  Scenario Outline: plv2u2 CPOE On - NoteWriter-Search from Patient Search-Patient
  ...
  Scenario Outline: plv2u2 CPOE On - NoteWriter-Search from Patient Search-Visit
    Given I am logged into the portal with user "plv2u2" using the default password
    And I am on the "Patient Search" tab
    And I click the "Clear Criteria" button
    And I check the following checkboxes
  ...
  Scenario Outline: plv2u3 CPOE On - NoteWriter-Search from Patient Search-Patient
  ...
  Scenario Outline: plv2u3 CPOE On - NoteWriter-Search from Patient Search-Visit
    Given I am logged into the portal with user "plv2u3" using the default password
    And I am on the "Patient Search" tab
    And I click the "Clear Criteria" button
    And I check the following checkboxes
  ...
  Scenario Outline: plv2u4 CPOE On - NoteWriter
...
#    And I refresh the patient list
  ...
  Scenario Outline: plv2u5 CPOE On - NoteWriter
...
#    And I refresh the patient list
  ...
  Scenario Outline: plv2u6 CPOE On - NoteWriter-Search from Patient Search-Patient
  ...
  Scenario Outline: plv2u6 CPOE On - NoteWriter-Search from Patient Search-Visit
    Given I am logged into the portal with user "plv2u6" using the default password
    And I am on the "Patient Search" tab
    And I click the "Clear Criteria" button
    And I check the following checkboxes
  ...
  Scenario Outline: plv2u7 CPOE On - NoteWriter-Search from Patient Search-Visit
  ...
  Scenario Outline: plv2u7 CPOE On - NoteWriter-Search from Patient Search-Patient
    Given I am logged into the portal with user "plv2u7" using the default password
    And I am on the "Patient Search" tab
    And I click the "Clear Criteria" button
    And I enter "<PatientLastName>" in the "Last" field in the "Patient Search Criteria" pane
  ...
  Scenario Outline: plv2u8 CPOE On - NoteWriter

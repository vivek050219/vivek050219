@NoteWriterQTV2
Feature: NoteWriter Quick Text V2
	...
	Scenario:Verify Keyboard shortcut are case-sensitive[Dev-57039]
		...
		And I select patient "Molly Darr" from the patient list
		And I click the "PatientnarrativeABCQTV2" abc link in the "Subjective" section of the "Progress Note" template
	...
	Scenario:Verify quicktext is trigger, tab will bring user to the first smart tag[Dev-66639]
		...
		And I enter "Free text without label" in the "Free Text" free text field in the "Note Writer Main" pane
...
#		Then the following text should appear in the "ClickToInsertV2" pane
#			|Quick Text V2 |
      And I click the "Group QTV2" quicktext in the "ClickToInsertV2" pane
      Then the quicktext "Quick Text V2" should appear under the group "Group QTV2" in the "ClickToInsertV2" pane
		And I sign/submit the "Progress Note" note
...
#			|Quick Text DD |
        ...
        Then the quicktext "Quick Text DD" should appear under the group "Group1" in the "ClickToInsertV2" pane
		And I sign/submit the "Progress Note" note
	...
	Scenario: Insert and Edit Free Rich Text Markup without label and Verify in Note Detail page
		...
		When I click the "PatientnarrativeABCQTV2" abc link in the "Subjective" section of the "Progress Note" template
		...
		And I click the "Close" button in the "AddQuickText" pane
		And the "Note Writer Main" pane should load
	...
	Scenario: Verify the Free text and List in Note detail field
		...
		Then the text "The red Quick Texts in the following fields must be completed: Patient Narrative" should appear in the "Note Writer Main" pane
...
#		And I click the "NotationABCQTV2" abc link in the "Notation" section of the "Chart Notation AM" template
        ...
        And I select the note "Notation" section
        And I click on the element "NotationABCQTV2" in the "NoteWriter Main" pane
        And the "ClickToInsertV2" pane should load
...
#		And I click the "NotationABCQTV2" abc link in the "Notation" section of the "Chart Notation AM" template
		...
		When I click the "Close" button in the "Add Quick Text" pane
		When I enter "PK" in the "NotationQTV2" rich text field
		And I click the "space" key in the "NotationQTV2" rich text field
	...
	Scenario: Verify the quick text order of creation
		Given "Mona Angeline" is on the patient list
		And I select patient "Molly Darr" from the patient list
		When I load the "Progress Note" template note for the selected patient
		And I click the "OK" button in the "Information" pane if it exists
		Then I select the note "Subjective" section
...
#		Then I verify the text "This text is numbered" is numbered in advanced mode
	...
	Scenario: Verify Formated Text in Advanced Mode
		Given "Roy Blazer" is on the patient list
		And I select patient "Roy Blazer" from the patient list
		When I load the "Chart Notation AM" template note for the selected patient
		And I click the "OK" button in the "Information" pane if it exists
	    Then I select the note "Notation" section
		And I click the "BoldChartAM" element in the "NoteWriter" pane
		And I enter "This text is bold" in the "NotationQTV2" rich text field
		And I click the "BoldChartAM" element in the "NoteWriter" pane
		And I click the "ItalicChartAM" element in the "NoteWriter" pane
		And I enter "This text is italics" in the "NotationQTV2" rich text field
		And I click the "ItalicChartAM" element in the "NoteWriter" pane
...
#		And I click the "NumberedListChartAM" element in the "NoteWriter" pane
		And I click the "BulletListChartAM" button in the "NoteWriter" pane
		And I enter "This text is bulleted" in the "NotationQTV2" rich text field
		Then I click the "NoteWriterSign/Submit" button in the "Note Writer Main" pane
        And I wait "2" seconds
		And I click the "OK" button in the "Note Writer Main" pane
		When I select "Chart Notation" from the "Note Type (\d of \d)" column in the "Clinical Notes" table

@842Enhancements
Feature: NW User Filter By Visit Type
...
#  #surgery visit, only Op Report and Chart Notation note types would be available for selection.
  ...
  Background:
    ...
    When I search for the user "nwfilter"
    And I select the user "nwfilter"
  ...
  Scenario: Pre-req Default All Note Types as User Pickers
    When I click the "Reset User Pickers" button
    And I click the "Delete All" button in the "Warning" pane
    And I click the "My Pickers" edit category link in the "User Note Pickers" pane
    And I wait "2" seconds
    Then the "Edit My Note Pickers" pane should load
    When I enter "History and Physical" in the "Add Code" field
    And I click the "Lookup Values" element
#    Wait for IE slowness
    ...
    And I click the "Lookup Values" element
    And I wait "2" seconds
    When I click the "Save" button in the "Edit User Note Pickers" pane
    And I wait "3" seconds
    Then the following fields should be enabled in the "User Note Pickers" pane
      | Name              | Type  |
      | FilterByVisitAll  | radio |
    And I click the "Close" button in the "User Note Pickers" pane
    Given I am logged into the portal with user "nwfilter" using the default password
  ...
  Scenario: User Pickers Filter-By-Visit-Type[DEV-78583][DEV-79483]
#    #Set History and Physical to Outpatient
    When I click the "History and Physical" link in the "User Note Pickers" pane
    And I wait "2" seconds
    Then the "Edit My Pickers By Visit" pane should load
    And I select "PK" from the "Include Visit Types" radio list in the "Edit My Pickers By Visit" pane
    Then I uncheck all checkboxes in "Edit My Pickers By Visit" pane
    Then I check the following checkboxes in the "Edit My Pickers By Visit" pane
      |Outpatient    |
    And I click the "SavePickers" button in the "Edit My Pickers By Visit" pane
#    #Set Chart Notation AM to All
    When I click the "Chart Notation AM" link in the "User Note Pickers" pane
    And I wait "4" seconds
    Then the "Edit My Pickers By Visit" pane should load
    And I select "PK" from the "Include Visit Types" radio list in the "Edit My Pickers By Visit" pane
    Then I uncheck all checkboxes in "Edit My Pickers By Visit" pane
    And I select "All" from the "Include Visit Types" radio list in the "Edit My Pickers By Visit" pane
    And I click the "SavePickers" button in the "Edit My Pickers By Visit" pane
#    #Set OperativeReport to ER
    When I click the "OperativeReport" link in the "User Note Pickers" pane
    And I wait "4" seconds
    Then the "Edit My Pickers By Visit" pane should load
    And I select "PK" from the "Include Visit Types" radio list in the "Edit My Pickers By Visit" pane
    Then I uncheck all checkboxes in "Edit My Pickers By Visit" pane
...
#    #Set Discharge Summary to Inpatient
    When I click the "Discharge Summary" link in the "User Note Pickers" pane
    And I wait "4" seconds
    Then the "Edit My Pickers By Visit" pane should load
    And I select "PK" from the "Include Visit Types" radio list in the "Edit My Pickers By Visit" pane
    Then I uncheck all checkboxes in "Edit My Pickers By Visit" pane
    Then I check the following checkboxes in the "Edit My Pickers By Visit" pane
      |Inpatient     |
    And I click the "SavePickers" button in the "Edit My Pickers By Visit" pane
    And I select "PK" from the "Visit Type Radio" radio list in the "User Note Pickers" pane
    Then I select "Outpatient" from the "PK Visit Types" dropdown in the "User Note Pickers" pane
    And I wait "2" seconds
    And only the following note pickers should be available
      | History and Physical |
      | Chart Notation AM    |
    Then I select "Inpatient" from the "PK Visit Types" dropdown in the "User Note Pickers" pane
    And I wait "2" seconds
    And only the following note pickers should be available
      | Chart Notation AM    |
      | Discharge Summary    |
    Then I select "ER" from the "PK Visit Types" dropdown in the "User Note Pickers" pane
    And I wait "2" seconds
    And only the following note pickers should be available
      | Chart Notation AM    |
      | OperativeReport      |
...
#  @NoteWriter
#  Scenario: Verify Filtered User Note Pickers Listed Next to Templates

  Scenario: Ensure Only All, PK, or ADT Radio Buttons can be Selected for User Note Pickers
    When I click the "History and Physical" link in the "User Note Pickers" pane
    And I wait "2" seconds
    Then the "Edit My Pickers By Visit" pane should load
    Then I select "All" from the "Include Visit Types" radio list in the "Edit My Pickers By Visit" pane
    And the following fields should be enabled in the "Edit My Pickers By Visit" pane
      | Name            | Type  |
      | AllVisitTypes   | radio |
    And the following fields should be disabled in the "Edit My Pickers By Visit" pane
      | Name   | Type  |
      | PK     | radio |
      | ADT    | radio |
    Then I select "ADT" from the "Include Visit Types" radio list in the "Edit My Pickers By Visit" pane
    And the following fields should be enabled in the "Edit My Pickers By Visit" pane
      | Name  | Type  |
      | ADT   | radio |
    Then the following fields should be disabled in the "Edit My Pickers By Visit" pane
      | Name            | Type  |
      | AllVisitTypes   | radio |
      | PK              | radio |
    And I select "PK" from the "Include Visit Types" radio list in the "Edit My Pickers By Visit" pane
    Then the following fields should be enabled in the "Edit My Pickers By Visit" pane
      | Name | Type  |
      | PK   | radio |
    And the following fields should be disabled in the "Edit My Pickers By Visit" pane
      | Name            | Type  |
      | AllVisitTypes   | radio |
      | ADT             | radio |
    And I click the "Cancel Pickers" button in the "Edit My Pickers By Visit" pane
    And I click the "Close" button in the "Department Note Pickers" pane

  Scenario: User Pickers - Ensure Only PK or ADT can be Selected for the Same Visit Type
    When I click the "History and Physical" link in the "User Note Pickers" pane
    And I wait "4" seconds
    Then the "Edit My Pickers By Visit" pane should load
    Then I select "PK" from the "Include Visit Types" radio list in the "Edit My Pickers By Visit" pane
    And the "Outpatient" checkbox should be checked in the "Edit My Pickers By Visit" pane
    Then I select "ADT" from the "Include Visit Types" radio list in the "Edit My Pickers By Visit" pane
    Then I check the following checkboxes in the "Edit My Pickers By Visit" pane
      |O:SIMHOSPITAL    |
    And I click the "SavePickers" button in the "Edit My Pickers By Visit" pane
    ...
    Then the "Edit My Pickers By Visit" pane should load
    Then I select "ADT" from the "Include Visit Types" radio list in the "Edit My Pickers By Visit" pane
    And the "O:SIMHOSPITAL" checkbox should be checked in the "Edit My Pickers By Visit" pane
    Then I select "PK" from the "Include Visit Types" radio list in the "Edit My Pickers By Visit" pane
    And the "Outpatient" checkbox should be unchecked in the "Edit My Pickers By Visit" pane
    Then I check the following checkboxes in the "Edit My Pickers By Visit" pane
      |Outpatient    |
    And I click the "SavePickers" button in the "Edit My Pickers By Visit" pane
    When I click the "History and Physical" link in the "User Note Pickers" pane
    ...
    Then the "Edit My Pickers By Visit" pane should load
    Then I select "ADT" from the "Include Visit Types" radio list in the "Edit My Pickers By Visit" pane
    And the "O:SIMHOSPITAL" checkbox should be unchecked in the "Edit My Pickers By Visit" pane
    Then I select "PK" from the "Include Visit Types" radio list in the "Edit My Pickers By Visit" pane
    And the "Outpatient" checkbox should be checked in the "Edit My Pickers By Visit" pane
    And I click the "SavePickers" button in the "Edit My Pickers By Visit" pane
    And I click the "Close" button in the "User Note Pickers" pane

  Scenario: Export User Note Pickers
    Given I wait "2" seconds
#    Wait an extra 2 seconds for IE
    Then the following note pickers should be available for the "NWfilterNoteTypes" department
      | History and Physical |
      | Chart Notation AM    |
      | OperativeReport      |
      | Discharge Summary    |
...
# DEV-79485 Fixed: This is now working in 842.  -- HIC 4/15/19
  Scenario: Import User Note Pickers[DEV-78583][DEV-79485][DEV-79787]
    Given I wait "2" seconds
#    Wait an extra 2 seconds for IE
    When I click the "Reset User Pickers" button
    And I click the "Delete All" button in the "Warning" pane
    When I click the "Import Pickers" button
    Then I import the "nwfilterPickerExport.csv" file using the "Choose File" Input element
...
#This isn't working in 841 either and supposedly is meant to be working in 841.  See [DEV-79483]. -- HIC 3/27/19
  Scenario: User - Change Visit Type Mid-Note Creation and Check for Warning[DEV-78583][DEV-79483]
    When I click the "Close" button in the "User Note Pickers" pane
...
#      | History and Physical |
  ...
  Scenario: User - Create Draft Note and then Change Note Picker Config[DEV-78583][DEV-79483]
    Then I click the "Close" button in the "User Note Pickers" pane
    Then I am on the "Patient List V2" tab
...
#    Then I click the "OK" button in the "Warning" pane
  ...
  Scenario: Post-req Delete Any User Notepickers
    When I click the "Reset User Pickers" button
    And I click the "Delete All" button in the "Warning" pane
    And I click the "Close" button in the "User Note Pickers" pane

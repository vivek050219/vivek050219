...
Feature: NoteWriter Quick Text V2 Navigate With Keyboard
  ...
  Scenario: Pre-req - Delete Any User and Dept QuickTexts Set Previously
    ...
    Then I select the "QTV2" department and "HCA Progress Note (Dept)" template and click "Quick Text (Summary View)" edit link in the NoteWriter pane
...
#    And "Roy Blazer" is on the patient list
#    When I select patient "Roy Blazer" from the patient list
    Then I click the "Patient narrative ABC QTV2" abc link in the "Subjective" section of the "HCA Progress Note" template
...
#    Then the value in the "Patient Narrative QTV2" field should be "Option 1 QT Multi Choice"
    Then The "Patient Narrative QTV2" text field should appear with the text "Option 1 QT Multi Choice" in the "NoteWriter" pane
    And I click the "NoteWriterCancelNote" button in the "Note Writer Main" pane
    Then I click the "Yes" button
...
#    Then the value in the "Patient Narrative QTV2" field should be "Option 1 QT Multi Choice"
    Then I verify if the following text is displayed in multiple lines in the field "Patient Narrative QTV2" in the "NoteWriter" pane
      | Option 1        |
      | QT Multi Choice |
    And I click the "NoteWriterCancelNote" button in the "Note Writer Main" pane
    Then I click the "Yes" button
...
#    Then the value in the "Patient Narrative QTV2" field should be "Option 2 QT Multi Choice"
    Then The "Patient Narrative QTV2" text field should appear with the text "Option 2 QT Multi Choice" in the "NoteWriter" pane
    And I click the "NoteWriterCancelNote" button in the "Note Writer Main" pane
    Then I click the "Yes" button

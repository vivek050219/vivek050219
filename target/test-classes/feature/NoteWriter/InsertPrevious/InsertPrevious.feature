@InsertPrevious
Feature: NoteWriter Insert Previous Scenarios
# ALM Path: Notewriter (PK)>> 009 - Insert Previous >> InsertPrevious
  ...
  Scenario: Create the First note at the Section level by entering data of ROS, Exam and A/P section using H&P Template
    ...
    And I click the "OK" button in the "Information" pane if it exists
    And I click the "ROS CONST Normal" button in the "Note Writer Main" pane
    ...
    And I enter "This is for search field ROS Eyes normal" in the "Ros Eyes Normal QTV2" rich text field
    ...
    When I click the "Exam GI Normal" element
    Then the text "Soft, no tenderness. No masses. No guarding. Bowel sounds present." should appear in the "Exam History" pane
  ...
  Scenario: Create the Second note using Insert previous link and by entering data at Section level of ROS, Exam and A/P section using H&P Template
    ...
    When I click the "Exam Resp Normal" element
    Then the text "Lungs clear to auscultation, no distress." should appear in the "Exam History" pane
    When I click the "Exam Psych Normal" element
    Then the text "Negative for specific complaints." should appear in the "Exam History" pane
    And I select the note "A/P" section
    And I click the "OK" button in the "Information" pane if it exists
    And I enter "Leg pain" in the "AP Diagnosis Search" field in the "NoteWriter APDX Search QTV2" pane
    And I select the "M79.606" code in the Diagnoses search list in the "NoteWriter APDX Search QTV2" pane
  ...
  # Test Case: 14 NW_AdvTemp_InsPrevSectionLevel
   ...
   # Validating the third note using second note insert previous link, data is not pulled from first note
    ...
    And the text "This scenario test the insert previous Field in the A/P section" should not appear in the "Note Writer Main" pane
    And I sign/submit the "History and Physical" note
  ...
  Scenario: Check Insert Previous for the all field of ROS, Exam and A/P section using H&P Template for nwdept1 user
   # Test Case:  06 NW_AdvTemp_InsPrevDepartment
    ...
    Then the text "PERL. Sclerae nonicteric. Conjunctivae pink." should appear in the "Note Writer Main" pane
    And I select the note "A/P" section
    And I enter "Chest pain radiating to arm" in the "AP Diagnosis Search" field in the "NoteWriter APDX Search QTV2" pane
    And I select the "R07.89" code in the Diagnoses search list in the "NoteWriter APDX Search QTV2" pane
  ...
  Scenario: Check Insert Previous for the all field of ROS, Exam and A/P section using H&P Template for nwdept3 user
    ...
    Then the text "Lungs clear to auscultation, no distress." should appear in the "Exam History" pane
    And I select the note "A/P" section
    And I enter "Fever" in the "AP Diagnosis Search" field in the "NoteWriter APDX Search QTV2" pane
    And I select the "R56.00" code in the Diagnoses search list in the "NoteWriter APDX Search QTV2" pane
  ...
  Scenario: Verify Data for ROS, Exam & A/P section using H&P Template for nwdept3 user irrespective of other 2 users
   # Test Case: 06 NW_AdvTemp_InsPrevDepartment
    ...
    And the following text should appear in the "ExamHistory" pane
      |Lungs clear to auscultation, no distress.  |
     # Below text should appear for user1 and user2 as they have same department. This text should not appear for user3 as it is associated to different deaprtment
    And the text "PERL. Sclerae nonicteric. Conjunctivae pink." should not appear in the "Exam Target Table" section in the "Note Writer Main" pane
    And I select the note "A/P" section
    And I click the "ESC" key in the "PN Diagnosis Search" field in the "Note Writer Main" pane
    And I click the "Problem List" insert previous link in the "Note Writer Main" pane
    And I click the "Insert Selected" button in the "Data To Insert From Previous Notes" pane
    And the text "This scenario test the insert previous link for user3" should appear in the "Note Writer Main" pane
    ...
    And the text "This scenario test the insert previous link in Assessment Plan rich text field in the A/P section" should not appear in the "Note Writer Main" pane
    And I sign/submit the "History and Physical" note
  ...
  Scenario: Create initial note 1 to verify InsertPrevious
   # Test Case: 02 NW_AdvTemp_InsPrevInitialCreateInitialMaxNum
    ...
    And I verify if "ROS" insert previous link is disabled in the "Note Writer Main" pane
    And I select the note "Exam" section
    And I verify if "Exam Target" insert previous link is disabled in the "Note Writer Main" pane
    And I select the note "A/P" section
    And I enter "toe" in the "AP Diagnosis Search" field in the "NoteWriter APDX Search QTV2" pane
    And I select the "S90.416A" code in the Diagnoses search list in the "NoteWriter APDX Search QTV2" pane
    And I verify if "Problem List" insert previous link is disabled in the "Note Writer Main" pane
    And I sign/submit the "History and Physical" note
    And I am on the "Patient List V2" tab
    And I click the "Refresh Patient List" button
    And I select patient "Roy Blazer" from the patient list
  ...
  Scenario: Create note 2 to verify InsertPrevious Max number
   # Test Case: 03 NW_AdvTemp_InsPrevUserCreateMaxNum-1
    ...
    And I select the note "A/P" section
    And I enter "head" in the "AP Diagnosis Search" field in the "NoteWriter APDX Search QTV2" pane
    And I select the "Head ache" codedescription in the Diagnoses search list in the "NoteWriter APDX Search QTV2" pane
    And I sign/submit the "History and Physical" note
    And I am on the "Patient List V2" tab
    And I click the "Refresh Patient List" button
    And I select patient "Roy Blazer" from the patient list
  ...
  Scenario: Create note 3 to verify InsertPrevious Max number
   # Test case: 03 NW_AdvTemp_InsPrevUserCreateMaxNum-2
    ...
    And I select the note "A/P" section
    And I enter "finger" in the "AP Diagnosis Search" field in the "NoteWriter APDX Search QTV2" pane
    And I select the "S60.419A" code in the Diagnoses search list in the "NoteWriter APDX Search QTV2" pane
  ...
  Scenario: Create note 4 to verify InsertPrevious Max number
   # Test Case: 03 NW_AdvTemp_InsPrevUserCreateMaxNum-3
    And I load the "History and Physical" template note for the selected patient
    And I select the note "ROS" section
    And I click the "ROS CONST Normal" button
    And I click the "ROS PSYCH Abnormal" button
    And I select the note "A/P" section
    And I enter "renal" in the "AP Diagnosis Search" field in the "NoteWriter APDX Search QTV2" pane
    And I select the "N15.1" code in the Diagnoses search list in the "NoteWriter APDX Search QTV2" pane
    And I sign/submit the "History and Physical" note
    And I am on the "Patient List V2" tab
    And I click the "Refresh Patient List" button
    And I select patient "Roy Blazer" from the patient list
  ...
  # Test Case: 03 NW_AdvTemp_InsPrevUserCreateMaxNum-4
    ...
    And I select the note "A/P" section
    And I enter "back" in the "AP Diagnosis Search" field in the "NoteWriter APDX Search QTV2" pane
    And I select the "S20.419A" code in the Diagnoses search list in the "NoteWriter APDX Search QTV2" pane
    And I sign/submit the "History and Physical" note
    And I am on the "Patient List V2" tab
    And I click the "Refresh Patient List" button
    And I select patient "Roy Blazer" from the patient list
  ...
  # Test Case: 03 NW_AdvTemp_InsPrevUserCreateMaxNum-5
    ...
    And I select the note "A/P" section
    And I enter "elbow" in the "AP Diagnosis Search" field in the "NoteWriter APDX Search QTV2" pane
    And I select the "S50.319A" code in the Diagnoses search list in the "NoteWriter APDX Search QTV2" pane
    And I click the "Save as Draft" button in the "Clinical Note" pane
    Then I click the "Yes" button in the "Note Writer Main" pane
    And I am on the "Patient List V2" tab
    And I click the "Refresh Patient List" button
  ...
  Scenario: Create note 7 to verify InsertPrevious Max number
   # Test Case: 03 NW_AdvTemp_InsPrevUserCreateMaxNum-6
    ...
    And I select the note "A/P" section
    And I enter "muscle" in the "AP Diagnosis Search" field in the "NoteWriter APDX Search QTV2" pane
    And I select the "Muscle abscess" codedescription in the Diagnoses search list in the "NoteWriter APDX Search QTV2" pane
    And I sign/submit the "History and Physical" note
    And I am on the "Patient List V2" tab
    And I click the "Refresh Patient List" button
    And I select patient "Roy Blazer" from the patient list
  ...
  # Test Case: 03 NW_AdvTemp_InsPrevUserCreateMaxPlus
    ...
    And I select the note "A/P" section
    And I enter "burn" in the "AP Diagnosis Search" field in the "NoteWriter APDX Search QTV2" pane
    And I select the "T30.0" code in the Diagnoses search list in the "NoteWriter APDX Search QTV2" pane
    And I select the note "ROS" section
...
#    And I verify if "Problem List" insert previous link is enabled in the "Note Writer Main" pane
    ...
    Then the following text should appear in the "Data To Insert From Previous Notes" pane
      |Toe abrasion |
    And I click the "Insert Selected" button in the "Data To Insert From PreviousNotes" pane
    And I click the "Problem List" insert previous link in the "Note Writer Main" pane
    And I wait "5" seconds
  ...
  Scenario: Verify new text gets appended to InsertPrevious text for Exam section
   # Test Case: 04 NW_AdvTemp_InsPrevAppend
    ...
    And I select the note "A/P" section
    And I enter "skin" in the "AP Diagnosis Search" field in the "NoteWriter APDX Search QTV2" pane
    And I select the "L98.9" code in the Diagnoses search list in the "NoteWriter APDX Search QTV2" pane
    ...
    And I click the "Insert Selected" button in the "Data To Insert From Previous Notes" pane
    And the text "This is a test." should appear in the "Note Writer Main" pane
    And I enter "This is new line added to other field" in the "Exam Other QTV2" rich text field
    And the text "This is new line added to other field" should appear in the "Note Writer Main" pane
    And I sign/submit the "History and Physical" note
    And I click the logout button
    Given I am logged into the portal with user "ipuser1" using the default password
    And I am on the "Patient List V2" tab
  ...
  # Test Case: 04 NW_AdvTemp_InsPrevAppend
    ...
    Then the text "This is QuickText for AP field" should appear in the "Note Writer Main" pane
    And I sign/submit the "History and Physical" note
    And "Roy Blazer" is on the patient list
    And I select patient "Roy Blazer" from the patient list
    And I select "Clinical Notes" from clinical navigation
    ...
    And I sort the "Clinical Notes" table chronologically by the "Date/Time" column in "Descending" order
    When I select "History and Physical" from the "Note Type (\d of \d)" column in the "Clinical Notes" table
    Then the text "This is QuickText for AP field" should appear in the "Progress Note" pane
    And the text "This is freeform text" should appear in the "Progress Note" pane
  ...
  Scenario: Verify no duplicate entry using InsertPrevious
   # Test Case: 05 NW_AdvTemp_InsPrevClinicDataNoDupe
    ...
    And I click the "ROS" insert previous link in the "Note Writer Main" pane
    And I click the "Insert Selected" button in the "Data To Insert From Previous Notes" pane
    Then the text "Negative for blurry vision. No diplopia." should appear in the "Note Writer Main" pane
    And I click the "ROS" insert previous link in the "Note Writer Main" pane
  ...
  Scenario: Verify InsertPrevious within same facility group
   # Test Case: 09 NW_AdvTemp_InsPrevFacility
    ...
    And I click the "Insert Selected" button in the "Data To Insert From Previous Notes" pane
    And I click the "ROS" insert previous link in the "Note Writer Main" pane
    Then the text "RESP" should appear in the "Data To Insert From Previous Notes" pane
    And I click the "Insert Selected" button in the "Data To Insert From Previous Notes" pane
    And I select the note "Exam" section
    And I click the "OK" button in the "Information" pane if it exists
    And I wait "3" seconds
  ...
  Scenario: Create a History and physical of Ros, Exam and A/P section for Insert Previous link
    ...
    Then the text "Negative for dyspnea or wheeze. No cough." should appear in the "ROS History" pane
    Then I select the note "Exam" section
    When I click the "Exam Psych Normal" element in the "Note Writer Main" pane
    Then the text "Negative for specific complaints." should appear in the "Exam History" pane
    When I click the "Exam GI Normal" element
    Then the text "Soft, no tenderness. No masses. No guarding. Bowel sounds present." should appear in the "Exam History" pane
    And I select the note "A/P" section
    ...
    And I enter "This scenario test the insert previous Field in the A/P section" in the "Plan QTV2" rich text field
    And I enter "Leg pain" in the "Diagnosis Search" field in the "Note Writer APDX Search QTV2" pane
    And I select the "M79.606" code in the Diagnoses search list in the "Note Writer APDX Search QTV2" pane
    And I sign/submit the "History and Physical" note
  ...
  Scenario: Verifying the data copied with Insert Previous link of Ros, Exam and A/P section
    ...
    Then the following text should appear in the "Data To Insert From Previous Notes" pane
      |Negative for specific complaints.                                 |
      |Soft, no tenderness. No masses. No guarding. Bowel sounds present.|
    And I click the "Cancel Insert Previous" button in the "Data To Insert From Previous Notes" pane
    And I click the "Exam Target" insert previous link in the "Note Writer Main" pane
    Then the following text should appear in the "Data To Insert From Previous Notes" pane
      |Negative for specific complaints.                                 |
      |Soft, no tenderness. No masses. No guarding. Bowel sounds present.|
    And I uncheck the "GI Qtv2" checkbox
    And I click the "Insert Selected" button in the "Data To Insert From Previous Notes" pane
    Then the text "Negative for specific complaints." should appear in the "Exam History" pane
    And I select the note "A/P" section
    And I click the "ESC" key in the "PN Diagnosis Search" field in the "Note Writer Main" pane
    And I enter "brain abscess" in the "Diagnosis Search" field in the "Note Writer APDX Search QTV2" pane
    And I select the "G06.0" code in the Diagnoses search list in the "Note Writer APDX Search QTV2" pane
  ...
  Scenario: Check Insert Previous link for the all field of ROS, and A/P section using H&P Template
    ...
    And I load the "History and Physical" template note for the selected patient
    And I select the note "ROS" section
    And I click the "ROS EYES Normal" button in the "NoteWriter Main" pane
    And I clear the "Ros Eyes Normal QTV2" rich text field
    And I enter "This is for search field ROS Eyes normal" in the "Ros Eyes Normal QTV2" rich text field
    And I click the "ROS RESP Normal" button in the "NoteWriter" pane
    Then the text "Negative for dyspnea or wheeze. No cough." should appear in the "ROS History" pane
    And I select the note "A/P" section
    And I enter "Chest pain radiating to arm" in the "AP Diagnosis Search" field in the "Note Writer APDX Search QTV2" pane
    And I select the "R07.89" code in the Diagnoses search list in the "Note Writer APDX Search QTV2" pane
    And I enter "This scenario test the insert previous Field in the A/P section" in the "PlanQTV2" rich text field
    And I enter "fever" in the "Diagnosis Search" field in the "Note Writer APDX Search QTV2" pane
    And I select the "R50.9" code in the Diagnoses search list in the "Note Writer APDX Search QTV2" pane
    And I sign/submit the "History and Physical" note
  ...
  Scenario: Create notes for different users within same department
   #Test Case : 12 NW_AdvTemp_InsPrevOptions
    ...
    And I select the note "ROS" section
    And I click the "ROS EYES Normal" button in the "NoteWriter Main" pane
    And I click the "ROS ENT Abnormal" button in the "NoteWriter Main" pane
    And I select the note "Exam" section
    And I click the "Exam Eyes Normal" element in the "Note Writer Main" pane
    And I select the note "A/P" section
    And I enter "toe" in the "AP Diagnosis Search" field in the "Note Writer APDX Search QTV2" pane
    And I select the "S90.416A" code in the Diagnoses search list in the "Note Writer APDX Search QTV2" pane
    And I sign/submit the "History and Physical" note
    Given I am logged into the portal with user "ipuser2" using the default password
    And I am on the "Patient List V2" tab
    And "Roy Blazer" is on the patient list
    ...
    And I wait "3" seconds
    And I select the note "ROS" section
    And I click the "ROS MSK Normal" button in the "NoteWriter Main" pane
    And I click the "ROS HEMA Abnormal" button in the "NoteWriter Main" pane
    And I select the note "Exam" section
    And I click the "Exam Resp Normal" element in the "Note Writer Main" pane
    And I select the note "A/P" section
    And I enter "elbow" in the "AP Diagnosis Search" field in the "Note Writer APDX Search QTV2" pane
    And I select the "S50.319A" code in the Diagnoses search list in the "Note Writer APDX Search QTV2" pane
    And I sign/submit the "History and Physical" note
  ...
  Scenario: Add problem to favorite list
    ...
    And I load the "History and Physical" template note for the selected patient
    And I select the note "A/P" section
    And I enter "toe" in the "AP Diagnosis Search" field in the "NoteWriter AP DX Search QTV2" pane
    And I select the "S90.416A" code in the Diagnoses search list in the "NoteWriter AP DX Search QTV2" pane
    And I click the "Favorite Dx" image in the "Note Writer Main" pane if it exists
  ...
  Scenario: Create note with favorite problem in A/P section
    ...
    And I click the "Exam Eyes Normal" element in the "Note Writer Main" pane
    And I select the note "A/P" section
    And I choose the "S90.416A" code in the "Favorites" list in the "Favorite Diagnoses" search section in the "Note Writer AP DX Search QTV2" pane
    And I sign/submit the "History and Physical" note
  ...
  Scenario: Verify InsertPrevious for favorite problem in A/P section
    ...
    And I click the "ESC" key in the "AP Diagnosis Search" field in the "Note Writer Main" pane
    And I click the "Problem List" insert previous link in the "Note Writer Main" pane
    When I click the "Insert Selected" button in the "Data To Insert From Previous Notes" pane
    Then the following fields should display in the "Note Writer Main" pane
      |Name                 |Type    |
  ...
  Scenario: Create notes to verify InsertPrevious for users within same group
    ...
    And I click the "ROS MSK Normal" button in the "Note Writer Main" pane
    And I select the note "Exam" section
    And I click the "Exam Resp Normal" element in the "Note Writer Main" pane
    And I select the note "A/P" section
    And I click the "Add Problem" button in the "Note Writer Main" pane if it exists
    And I wait "2" seconds
    And I enter "Q74.0 in the "PN Diagnosis Search" field
  ...
  Scenario: Verify InsertPrevious across Departments
    ...
    And I select the note "Subjective" section
    And I wait "3" seconds
    And I click the "ROS GU Normal" button in the "Note Writer Main" pane
    And I select the note "Exam" section
    And I click the "Exam GI Normal" element in the "Note Writer Main" pane
    And I select the note "A/P" section
    And I click the "Add Problem" button in the "Note Writer Main" pane if it exists
    And I wait "2" seconds
    And I enter "F99" in the "PN Diagnosis Search" field
    And I sign/submit the "Progress Note" note
    And I click the logout button
    Given I am logged into the portal with user "ipuser3" using the default password
    And I am on the "Patient List V2" tab
  ...
  Scenario: Create Draft notes to verify InsertPrevious
    ...
    And I select the note "Subjective" section
    And I wait "3" seconds
    And I click the "ROS ALL/IMM Normal" button in the "Note Writer Main" pane
    And I select the note "Exam" section
    And I click the "Exam CV Abnormal" element in the "Note Writer Main" pane
    And I select the note "A/P" section
    And I click the "Add Problem" button in the "Note Writer Main" pane if it exists
    And I wait "2" seconds
    And I enter "L60.9" in the "PN Diagnosis Search" field
    ...
    And I click the "Edit" button in the "Progress Note" pane
    And I select the note "Subjective" section
    And I wait "3" seconds
  ...
  Scenario: Create notes by different users of different department
    ...
    And I select the note "ROS" section
    And I click the "ROS GI Normal" button in the "Note Writer Main" pane
    And I click the "ROS NEURO Abnormal" button in the "Note Writer Main" pane
    ...
    And I select the note "ROS" section
    And I click the "ROS GU Normal" button in the "Note Writer Main" pane
    And I click the "ROS Skin Abnormal" button in the "Note Writer Main" pane
    And I select the note "Exam" section
    And I click the "Exam Eyes Normal" element in the "Note Writer Main" pane
    And I select the note "A/P" section
    And I enter "finger" in the "AP Diagnosis Search" field in the "NoteWriter APDX Search QTV2" pane
  ...
  Scenario: Verify InsertPrevious for another user within same department
    ...
    And I click the "Insert Selected" button in the "Data To Insert From Previous Notes" pane
    Then the text "GASTROINTESTINAL" should appear in the "Note Writer Main" pane
    Then the text "NEUROLOGICAL" should appear in the "Note Writer Main" pane
    And I select the note "Exam" section
    And I click the "Exam Target" insert previous link in the "Note Writer Main" pane
    Then the checkbox for the following text should present with the given status in the insert previous notes pane
      |Text                                         |Status  |
      |RESPIRATORY                                  |Enabled |
    And I click the "Insert Selected" button in the "Data To Insert From Previous Notes" pane
    Then the text "RESPIRATORY" should appear in the "Note Writer Main" pane
    And I select the note "A/P" section
    And I click the "Proble mList" insert previous link in the "Note Writer Main" pane
    Then the checkbox for the following text should present with the given status in the insert previous notes pane
      |Text                                         |Status  |
      |Head ache                                     |Enabled |
    And I click the "Insert Selected" button in the "Data To Insert From Previous Notes" pane
    Then the text "Head ache" should appear in the "Note Writer Main" pane
    And I save the template as Draft
  ...
  Scenario: Verify no duplicate for normal and abnormal entries using InsertPrevious
    ...
    And I load the "Progress Note" template note for the selected patient
    And I select the note "Subjective" section
    And I click the "ROS CONST Abnormal" button in the "Note Writer Main" pane
    And I enter "It is free text for ROS" in the "ROS Const QTV2" rich text field
    And I click the "ROS" insert previous link in the "Note Writer Main" pane
#    Then the checkbox for the following text should present with the given status in the insert previous notes pane
#      |Text                         |Status   |
#      |CONSTITUTIONAL               |Disabled |
    And I click the "Insert Selected" button in the "Data To Insert From Previous Notes" pane
    Then the "ROS Target Table" table should have "1" rows containing the text "CONSTITUTIONAL"
    And I sign/submit the "Progress Note" note
  ...
  Scenario: Create notes to verify problem sorting in A/P section
   #Test Case : NW_AdvTemp_InsPrev_Problem_Sorting
    ...
    And I click the "Add Problem" button in the "Note Writer Main" pane if it exists
    And I wait up to "3" seconds for loading to complete
    And I enter "Leg" in the "AP Diagnosis Search" field in the "Note Writer APDX Search QTV2" pane
    And I select the "Leg cramp" codedescription in the Diagnoses search list in the "Note Writer APDX Search QTV2" pane
    And I wait up to "3" seconds for loading to complete
    Then the text "Leg cramp" should appear in the "Note Writer Main" pane
    And I enter "Hand" in the "AP Diagnosis Search" field in the "Note Writer APDX Search QTV2" pane
    And I select the "Hand anomaly" codedescription in the Diagnoses search list in the "Note Writer AP DX Search QTV2" pane
    And I wait up to "3" seconds for loading to complete
    Then the text "Hand anomaly" should appear in the "Note Writer Main" pane
    And I enter "Toe" in the "AP Diagnosis Search" field in the "Note Writer APDX Search QTV2" pane
    And I select the "Toe anomaly" codedescription in the Diagnoses search list in the "Note Writer AP DX Search QTV2" pane
    And I wait up to "3" seconds for loading to complete
    Then the text "Toe anomaly" should appear in the "Note Writer Main" pane
    And I enter "Head" in the "AP Diagnosis Search" field in the "Note Writer APDX SearchQTV2" pane
    And I select the "Head banging" codedescription in the Diagnoses search list in the "Note Writer APDX Search QTV2" pane
    And I wait up to "3" seconds for loading to complete
    Then the text "Head banging" should appear in the "Note Writer Main" pane
    And I enter "Tongue" in the "AP Diagnosis Search" field in the "Note Writer APDX Search QTV2" pane
    And I select the "Tongue abnormality" codedescription in the Diagnoses search list in the "Note Writer APDX Search QTV2" pane
    And I wait up to "3" seconds for loading to complete
    Then the text "Tongue abnormality" should appear in the "Note Writer Main" pane
    And I move the following problems to the mentioned position in the "Note Writer Main" pane
        |Problem            |Position |
        |Leg cramp          |3        |
        |Toe anomaly        |5        |
  ...
  Scenario: Verify problems order in InsertPrevious page
    ...
    And I wait "3" seconds
    And I select the note "A/P" section
    And I click the "ProblemList" insert previous link in the "Note Writer Main" pane
    ...
    Then the following problems should appear in the mentioned position in the "Problem Target" pane
      ...
      | Tongue abnormality | 4        |
      | Toe anomaly        | 5        |
    And I enter "Eyes" in the "AP Diagnosis Search" field in the "Note Writer APDX Search QTV2" pane
    And I select the "Eyes swollen" codedescription in the Diagnoses search list in the "Note Writer AP DX Search QTV2" pane
    And I wait up to "3" seconds for loading to complete
    Then the text "Eyes swollen" should appear in the "Note Writer Main" pane
    And I enter "Hear" in the "AP Diagnosis Search" field in the "Note Writer APDX Search QTV2" pane
    And I select the "Hearing aid worn" codedescription in the Diagnoses search list in the "Note Writer APDX Search QTV2" pane
    And I wait up to "3" seconds for loading to complete
    Then the text "Hearing aid worn" should appear in the "Note Writer Main" pane
    And I move the following problems to the mentioned position in the "Note Writer Main" pane
      | Problem            | Position |
      | Hearing aid worn | 6        |
    Then the following problems should appear in the mentioned position in the "Problem Target" pane
